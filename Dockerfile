...
# install caddy
ARG CAD_URL=https://caddy.fr.bleatingsheep.org/download/linux/arm64?plugins=http.cache,http.cors,http.expires,http.git,http.realip,tls.dns.dnspod\&license=personal\&telemetry=off
